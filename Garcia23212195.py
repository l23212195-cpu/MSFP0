...
print(f"El valor de la resistencia Cr es de {Re} Faradios.\n")
print(f"El valor de la resistencia Cr es de {Rr} Faradios.\n")
...
# Colores
clr1 = np.array([139, 38, 38])/255
clr2 = np.array([239, 105, 5])/255
clr3 = np.array([72, 108, 47])/255
